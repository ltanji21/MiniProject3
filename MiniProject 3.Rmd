...
Next we have our data on remake films. Unlike with our sequel data, we do not see a decline in production following the introduction of sound. Interestingly, no films stand out that would account for the spike in the early 2000s. However, we see remakes that were commercial failures and snuffed by reviewers[^7] in the 2010s, which may account for the fluctuation seen at this time. Unlike with the larger sequel data, there is actually an increase in the number of remake films almost immediately after sound is introduced. While it is can not be determined with certainty, we hypothesize that this is a limitation of the small data and does not reflect the film history in general.
...
[^6]:https://www.theatlantic.com/entertainment/archive/2010/07/-hopefully-the-last-airbender/59052/
